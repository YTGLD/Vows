...
public class RecipePluginFinder {

    private RecipePluginFinder() {

    }
    public static List<RegisterRecipeConfig> getModPlugins() {
        return getInstances(RecipePlugin.class, RegisterRecipeConfig.class);
    }
